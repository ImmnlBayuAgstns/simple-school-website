        ...
        <div class="container">
            ...
            <ul class="navbar-nav ms-auto p-4 p-lg-0">
                ...
                <ul class="navbar-nav ms-auto">
                    <li class="nav-item">
                        <form method="post">
                            <a class="btn btn-primary " href="signupadmin.php">Tambah Akun</a>
        ...
        <div class="card row-cols">
            ...
            <div class="card-body">
                <table class="table">
                    ...
                    <?php
                            // Proses Read Data
                            $sql2 = "SELECT * FROM absen WHERE kelas = '12' AND jurusan = 'tkj' ORDER BY id DESC";
